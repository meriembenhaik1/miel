    ...
    <footer className="bg-brown-800 text-cream-50 pt-16 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://facebook.com" className="bg-brown-700 hover:bg-honey-600 transition-colors p-2 rounded-full">
                <Facebook size={20} />
              </a>
              <a href="https://instagram.com" className="bg-brown-700 hover:bg-honey-600 transition-colors p-2 rounded-full">
                <Instagram size={20} />
              </a>
              <a href="https://twitter.com" className="bg-brown-700 hover:bg-honey-600 transition-colors p-2 rounded-full">
                <Twitter size={20} />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span>123 Honey Street, Algiers, Algeria</span>
              </li>
        ...
        <div className="pt-6 border-t border-brown-700 text-center md:flex md:justify-between md:items-center">
          <p>&copy; {currentYear} Youcef Miel. All rights reserved. Created by <a href="https://edg-informatique--kohl.vercel.app/?fbclid=PAZXh0bgNhZW0CMTEAAaeFuFYxwcg5jDRCAcqFx0AyDldVCOxr-LH59WgQSTzJ8vXGozrfLj3iWushig_aem_HgKiwghONRmbZy2W7xUguQ"> Edg informatique </a></p>
